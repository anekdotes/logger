...
class LogTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testLogInfo()
    {
        //Setup Data
        Log::setDriver(new FileDriver('Toaster', 'tmp/test.log'));
        $testData = ['date' => date('Y-m-d H:i:s', time()), 'level' => 'INFO',  'remote_addr' => 'REMOTE_ADDR_UNKNOWN', 'request_uri' => 'REQUEST_URI_UNKNOWN', 'user_agent' => 'HTTP_USER_AGENT_UNKNOWN','test' => 'data', 'me' => 'you'];
        //Run Function
    ...
    public function testLogError()
    {
        //Setup Data
        Log::setDriver(new FileDriver('Toaster', 'tmp/test.log'));
        $testData = ['date' => date('Y-m-d H:i:s', time()), 'level' => 'ERROR', 'remote_addr' => 'REMOTE_ADDR_UNKNOWN', 'request_uri' => 'REQUEST_URI_UNKNOWN', 'user_agent' => 'HTTP_USER_AGENT_UNKNOWN', 'test' => 'data', 'me' => 'you'];
        //Setup Error Handler
        $toaster = 'Not Result';
    ...
    public function testLogWarning()
    {
        //Setup Data
        Log::setDriver(new FileDriver('Toaster', 'tmp/test.log'));
        $testData = ['date' => date('Y-m-d H:i:s', time()), 'level' => 'WARNING', 'remote_addr' => 'REMOTE_ADDR_UNKNOWN', 'request_uri' => 'REQUEST_URI_UNKNOWN', 'user_agent' => 'HTTP_USER_AGENT_UNKNOWN', 'test' => 'data', 'me' => 'you'];
        //Run Function
    ...
    public function testLogSuccess()
    {
        //Setup Data
        Log::setDriver(new FileDriver('Toaster', 'tmp/test.log'));
        $testData = ['date' => date('Y-m-d H:i:s', time()), 'level' => 'SUCCESS', 'remote_addr' => 'REMOTE_ADDR_UNKNOWN', 'request_uri' => 'REQUEST_URI_UNKNOWN', 'user_agent' => 'HTTP_USER_AGENT_UNKNOWN', 'test' => 'data', 'me' => 'you'];
        //Run Function
    ...
    public function testLogCritical()
    {
        //Setup Data
        Log::setDriver(new FileDriver('Toaster', 'tmp/test.log'));
        $testData = ['date' => date('Y-m-d H:i:s', time()), 'level' => 'CRITICAL', 'remote_addr' => 'REMOTE_ADDR_UNKNOWN', 'request_uri' => 'REQUEST_URI_UNKNOWN', 'user_agent' => 'HTTP_USER_AGENT_UNKNOWN', 'test' => 'data', 'me' => 'you'];
